    ...
    <div class="max-w-5xl px-4 xl:px-0 py-5 lg:pt-6 lg:pb-20 mx-auto">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
        ...
        <div>
          <!-- Heading -->
          <div class="mb-4">
            <h3 class="text-black text-xs font-medium uppercase">
              Steps
            </h3>
          </div>
          <!-- End Heading -->
          ...
          <a class="group inline-flex items-center gap-x-2 py-2 px-3 bg-black font-medium text-sm text-white rounded-full focus:outline-none" href="#">
